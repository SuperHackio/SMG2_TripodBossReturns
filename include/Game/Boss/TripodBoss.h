...
public:
    ...
    void exeSkipOpening(); // NEW to SMG2
    ...
    s32 mCageContents; // NEW to SMG2 (ObjArg0)
    bool mNoMusicChange; // NEW to SMG2 (ObjArg1)
    bool mSkipIntro; // NEW to SMG2 (ObjArg2)
};
...
namespace NrvTripodBoss {
    NERVE(TripodBossNrvTryStartDemo);
    NERVE(TripodBossNrvNonActive);
    NERVE(TripodBossNrvWait);
    NERVE(TripodBossNrvStep);
    NERVE(TripodBossNrvWaitStep);
    NERVE(TripodBossNrvDamage);
    NERVE(TripodBossNrvChangeSequence);
    NERVE(TripodBossNrvLeaveLegOutOfPlayer);
    NERVE(TripodBossNrvStartDemo);
    NERVE(TripodBossNrvDamageDemo);
    NERVE(TripodBossNrvPainDemo);
    NERVE(TripodBossNrvBreakDownDemo);
    NERVE(TripodBossNrvExplosionDemo);

    NERVE(TripodBossNrvSkipOpening); // NEW to SMG2
};