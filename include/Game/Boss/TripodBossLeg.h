...
public:
    ...
    f32 calcLegHeight(TripodBossStepPoint *) const;
    void updatePose();
    void updateIKPose();
...
namespace NrvTripodBossLeg {
    NERVE(TripodBossLegNrvHold);
    NERVE(TripodBossLegNrvDemo);
    NERVE(TripodBossLegNrvMove);
    NERVE(TripodBossLegNrvUp);
    NERVE(TripodBossLegNrvLeaveOut);
    NERVE(TripodBossLegNrvMoveToLandingPos);
    NERVE(TripodBossLegNrvStampSign);
    NERVE(TripodBossLegNrvLanding);
    NERVE(TripodBossLegNrvDamageVibration);
    NERVE(TripodBossLegNrvDamage);
    NERVE(TripodBossLegNrvBreak);
};