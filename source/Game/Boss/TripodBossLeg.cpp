...
namespace NrvTripodBossLeg {
    void TripodBossLegNrvHold::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeHold();
    }
    TripodBossLegNrvHold(TripodBossLegNrvHold::sInstance);

    void TripodBossLegNrvDemo::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeDemo();
    }
    TripodBossLegNrvDemo(TripodBossLegNrvDemo::sInstance);

    void TripodBossLegNrvMove::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeMove();
    }
    TripodBossLegNrvMove(TripodBossLegNrvMove::sInstance);

    void TripodBossLegNrvUp::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeUp();
    }
    TripodBossLegNrvUp(TripodBossLegNrvUp::sInstance);

    void TripodBossLegNrvLeaveOut::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeLeaveOut();
    }
    TripodBossLegNrvLeaveOut(TripodBossLegNrvLeaveOut::sInstance);

    void TripodBossLegNrvMoveToLandingPos::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeMoveToLandingPos();
    }
    TripodBossLegNrvMoveToLandingPos(TripodBossLegNrvMoveToLandingPos::sInstance);

    void TripodBossLegNrvStampSign::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeStampSign();
    }
    TripodBossLegNrvStampSign(TripodBossLegNrvStampSign::sInstance);

    void TripodBossLegNrvLanding::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeLanding();
    }
    TripodBossLegNrvLanding(TripodBossLegNrvLanding::sInstance);

    void TripodBossLegNrvDamageVibration::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeDamageVibration();
    }
    TripodBossLegNrvDamageVibration(TripodBossLegNrvDamageVibration::sInstance);

    void TripodBossLegNrvDamage::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeDamage();
    }
    TripodBossLegNrvDamage(TripodBossLegNrvDamage::sInstance);

    void TripodBossLegNrvBreak::execute(Spine* pSpine) const {
        ((TripodBossLeg*)pSpine->mExecutor)->exeBreak();
    }
    TripodBossLegNrvBreak(TripodBossLegNrvBreak::sInstance);
};
...
TripodBossLeg::TripodBossLeg(const char *pName) : LiveActor(pName), mBoss(NULL), mMoveArea(NULL), _94(0), _98(0), mJoint(new IKJoint()),
...
void TripodBossLeg::init(const JMapInfoIter &rIter) {
    initNerve(&NrvTripodBossLeg::TripodBossLegNrvHold::sInstance, 0);
    MR::invalidateClipping(this);
    initHitSensor(1);
    MR::addHitSensorMtx(this, "body", ATYPE_MAP_OBJ, 16, 1000.0f, (MtxPtr)&mEndJointMtx, TVec3f(500.0f, 200.0f, 0.0f));
    initSound(6, false, NULL, TVec3f(0.0f));
    ...
    MR::setEffectHostMtx(this, "LegSmoke", (MtxPtr) & mEndJointMtx);
    makeActorAppeared();
}

void TripodBossLeg::initShadow(const char *pName) {
    MR::initShadowVolumeFlatModel(this, pName, (MtxPtr) & _1C0);
...
void TripodBossLeg::setIKParam(f32 rootLength, f32 middleLength, const TVec3f &a3, const TVec3f &a4, const TVec3f &a5) {
    IKJoint_SMG1::setRootBoneLength(mJoint, rootLength);
    IKJoint_SMG1::setMiddleBoneLength(mJoint, middleLength);
    IKJoint_SMG1::setFirstPose(mJoint, a4, a5);
    _210 = a3;
    TVec3f v12(_210);
    v12.y = 0.0f;
    _A0.identity();
...
void TripodBossLeg::exeMoveToLandingPos() {
    ...
    if (JMathInlineVEC::PSVECSquareDistance((const Vec*) & mForceEndPoint, (const Vec*) & _240) < 90000.0f) {
...
void TripodBossLeg::exeLanding() {
    ...
    TVec3f endJointPos;
    IKJoint_SMG1::getEndJointPosition(mJoint, &endJointPos);
    HitResult hitResult;
    TVec3f v8(endJointPos);
    v8 -= v12;
    if (mMoveArea->collideSphere(&hitResult, v12, 0.0f, v8)) {
        MR::startSoundObject(_260, "SE_BM_TRIPOD_LAND");
        f32 dist = PSVECDistance((const Vec*)&mForceEndPoint, (const Vec*)MR::getPlayerPos());
        if (dist < 2000.0f) {
        ...
        IKJoint_SMG1::getEndJointPosition(mJoint, &mForceEndPoint);
        updateAnkleLanding();
    }
}
...
void TripodBossLeg::addIKLimitPower() {
    TVec3f rootJoint;
    IKJoint_SMG1::getRootJointPosition(mJoint, &rootJoint);
    TVec3f v12(rootJoint);
    v12 -= mForceEndPoint;
    f32 v8;
    MR::separateScalarAndDirection(&v8, &v12, v12);
    f32 maxDist = IKJoint_SMG1::getMaxLimitDistance(mJoint);
    f32 minDist = IKJoint_SMG1::getMinLimitDistance(mJoint);
...
void TripodBossLeg::updateIKPose() {
    ...
    switch (_24C) {
        case 0:
        {
            ...
            IKJoint_SMG1::updateByUpVector(mJoint, v4, mForceEndPoint, legUp);
            break;
        }
        case 1:
            IKJoint_SMG1::updateByLocalRootAndWorldTarget(mJoint, bodyMtx, _210, mForceEndPoint);
            break;
    }
...
bool TripodBossLeg::bindEndPosition() {
    ...
    if (mMoveArea->collideSphere(&hitResult, v6, 0.0f, v4)) {
        ...
        if (_234.dot(hitResult._18) < 0.0f) {
            ...
            JMAVECScaleAdd((const Vec*)&hitResult._18, (const Vec*)&_234, (Vec*)&_234, -dot);
        }
...
void TripodBossLeg::separateLocalAxisRootJoint(const TPos3f &rPos) {
    TPos3f v5;
    v5.set(rPos);
    v5.setTrans(TVec3f(0.0f));
    v5.concat(rPos, _A0);
    MR::separateMatrixRotateYZX(&mRootLocalYMtx, &mRootLocalYZMtx, v5, mJoint->_30);
    TVec3f jointRootPos;
    IKJoint_SMG1::getRootJointPosition(mJoint, &jointRootPos);
...
void TripodBossLeg::updateAnkleShadowMatrix() {
    ...
    MR::setShadowDropDirection(this, NULL, -landingNormal);
    v9.set(mEndJointMtx.mMtx[0][0], mEndJointMtx.mMtx[1][0], mEndJointMtx.mMtx[2][0]);
    v8.set(mEndJointMtx.mMtx[0][1], mEndJointMtx.mMtx[1][1], mEndJointMtx.mMtx[2][1]);
    v7.set(mEndJointMtx.mMtx[0][2], mEndJointMtx.mMtx[1][2], mEndJointMtx.mMtx[2][2]);
    // Manual inline moment
    //_1C0.setVec(, -v9, v8);
    v7 = -v7;
    v9 = -v9;
    _1C0.mMtx[0][0] = v7.x;
...
namespace MR {
    void separateMatrixRotateYZX(TPos3f* a1, TPos3f* a2, const TPos3f& a3, const TPos3f& a4) {
        ...
        f32 x = v17.mMtx[0][0];
        v16.set(x, y, z);
        f32 v10 = sqrt((v16.x * v16.x) + (v16.z * v16.z));

        if (MR::isNearZero(v10, 0.000001f)) {
            if (v16.y >= 0.0f) {
                a1->setXDir(TVec3f(0.0f, 1.0f, 0.0f));
                a1->setYDir(TVec3f(-1.0f, 0.0f, 0.0f));
            ...
            a1->setZDir(TVec3f(0.0f, 0.0f, 1.0f));
            a1->concat(a3, *a1);
            a2->set(*a1);
        }
        else {
            f32 v11 = PSVECMag((const Vec*) & v16);
            f32 v12 = (v10 / v11);
            f32 v14 = (v16.y / v11);
            f32 v15 = (v16.x / v10);
            f32 v13 = (v16.z / v10);

            a1->setXDir(TVec3f(v15, 0.0f, v13));
            a1->setYDir(TVec3f(0.0f, 1.0f, 0.0f));
            a1->setZDir(TVec3f(-v13, 0.0f, v15));
            a1->setTrans(TVec3f(0.0f, 0.0f, 0.0f));
            a2->setXDir(TVec3f(v12, v14, 0.0f));
            a2->setYDir(TVec3f(-v14, v12, 0.0f));
            a2->setZDir(TVec3f(0.0f, 0.0f, 1.0f));
            a2->setTrans(TVec3f(0.0f, 0.0f, 0.0f));
            a1->concat(a3, *a1);
            a2->concat(*a1, *a2);
        }
    }
