...
#include "Game/Boss/TripodBossLeg.h"
#include "Game/Boss/TripodBossMovableArea.h"
#include "Game/Boss/TripodBossStepPoint.h"
#include "Game/Boss/TripodBossStepSequence.h"
...
extern "C"
{
    DummyDisplayModel* __kAutoMap_80295440(LiveActor*, const JMapInfoIter&, s32, int); // @unnamed@DummyDisplayModel_cpp@::tryCreateDummyModel
    void __kAutoMap_8002B2D0(const NameObj*, const TVec3f&, u32, TVec3f*, GravityInfo*, u32); // @unnamed@GravityUtil_cpp@::calcGravityVectorOrZero
}
...
namespace NrvTripodBoss {
    void TripodBossNrvTryStartDemo::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeTryStartDemo();
    }
    TripodBossNrvTryStartDemo(TripodBossNrvTryStartDemo::sInstance);

    void TripodBossNrvNonActive::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeNonActive();
    }
    TripodBossNrvNonActive(TripodBossNrvNonActive::sInstance);

    void TripodBossNrvWait::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeWait();
    }
    TripodBossNrvWait(TripodBossNrvWait::sInstance);

    void TripodBossNrvStep::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeStep();
    }
    TripodBossNrvStep(TripodBossNrvStep::sInstance);

    void TripodBossNrvWaitStep::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeWaitStep();
    }
    TripodBossNrvWaitStep(TripodBossNrvWaitStep::sInstance);

    void TripodBossNrvDamage::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeDamage();
    }
    TripodBossNrvDamage(TripodBossNrvDamage::sInstance);

    void TripodBossNrvChangeSequence::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeChangeSequence();
    }
    TripodBossNrvChangeSequence(TripodBossNrvChangeSequence::sInstance);

    void TripodBossNrvLeaveLegOutOfPlayer::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeLeaveLegOutOfPlayer();
    }
    TripodBossNrvLeaveLegOutOfPlayer(TripodBossNrvLeaveLegOutOfPlayer::sInstance);

    void TripodBossNrvStartDemo::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeStartDemo();
    }
    TripodBossNrvStartDemo(TripodBossNrvStartDemo::sInstance);

    void TripodBossNrvDamageDemo::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeDamageDemo();
    }
    TripodBossNrvDamageDemo(TripodBossNrvDamageDemo::sInstance);

    void TripodBossNrvPainDemo::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exePainDemo();
    }
    TripodBossNrvPainDemo(TripodBossNrvPainDemo::sInstance);

    void TripodBossNrvBreakDownDemo::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeBreakDownDemo();
    }
    TripodBossNrvBreakDownDemo(TripodBossNrvBreakDownDemo::sInstance);

    void TripodBossNrvExplosionDemo::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeExplosionDemo();
    }
    TripodBossNrvExplosionDemo(TripodBossNrvExplosionDemo::sInstance);


    void TripodBossNrvSkipOpening::execute(Spine* pSpine) const {
        ((TripodBoss*)pSpine->mExecutor)->exeSkipOpening();
    }
    TripodBossNrvSkipOpening(TripodBossNrvSkipOpening::sInstance);
};
...
TripodBoss::TripodBoss(const char *pName) : LiveActor(pName), mLowModel(NULL), mMovableArea(NULL), mDummyModel(NULL),
    _5BC(0.0f, 3200.0f, 0.0f), _5C8(0, 0, 0), _5D4(0, 0, 0), _5E0(0, 0, 0), _5EC(0, 0, 0) {
...
void TripodBoss::init(const JMapInfoIter &rIter) {
    ...
    initModelManagerWithAnm(objName, NULL, NULL, false);
    MR::connectToSceneMapObj(this);
    char lowName[0x20];
    sprintf(lowName, "%sLow", objName);
    mLowModel = new ModelObj("三脚ボスLODモデル", lowName, getBaseMtx(), MR::DrawBufferType_TripodBoss, MR::CategoryList_Auto, MR::CategoryList_Auto, false);
    ...
    initSound(8, false, NULL, TVec3f(0.0f));
    initEffectKeeper(0, "TripodBoss", false);
    MR::setEffectHostMtx(this, "BreakLight", (MtxPtr)&mBodyMtx);
    initNerve(&NrvTripodBoss::TripodBossNrvNonActive::sInstance, 0);
    MR::invalidateClipping(this);
    MR::needStageSwitchReadA(this, rIter);
    MR::FunctorV0M<TripodBoss *, void (TripodBoss::*)()> demoFunc = MR::Functor<TripodBoss>(this, &TripodBoss::requestOpeningDemo);
    MR::listenStageSwitchOnA(this, demoFunc);
    MR::useStageSwitchReadB(this, rIter);
    MR::useStageSwitchWriteDead(this, rIter);
    MR::declareStarPiece(this, 24);
    MR::getJMapInfoArg0NoInit(rIter, &mCageContents);
    if (mCageContents == 13 || mCageContents == 7)
        MR::declarePowerStar(this);
    MR::getJMapInfoArg1NoInit(rIter, &mNoMusicChange);
    MR::getJMapInfoArg2NoInit(rIter, &mSkipIntro);
    JMath::gekko_ps_copy12(&_BC, &mBodyMtx);
    MR::addTransMtxLocal((MtxPtr) & _BC, _5BC);

    // This exact version of the function doesn't exist in SMG2. The header in Syati is incorrect.
    //mDummyModel = MR::createDummyDisplayModel(this, rIter, (MtxPtr) & _BC, 13, TVec3f(0.0f, 0.0f, 0.0f), TVec3f(0.0f, 0.0f, 0.0f));
    {
        if (mCageContents >= 0)
            mDummyModel = __kAutoMap_80295440(this, rIter, mCageContents, -1); // 13 is Grand Star
        
        if (mDummyModel != NULL)
        {
            mDummyModel->initFixedPosition((MtxPtr)&_BC, TVec3f(0.0f, 0.0f, 0.0f), TVec3f(0.0f, 0.0f, 0.0f));


            if (MR::isExistBrk(mDummyModel, "Recover"))
            {
    ...
    makeActorAppeared();
    MR::startBck(this, "StartDemo", NULL);
...
void TripodBoss::initLegIKPlacement() {
    ...
    TVec3f v27;
    PSVECCrossProduct((const Vec*)&v29, (const Vec*)&v28, (Vec*)&v27);
...
void TripodBoss::initMovableArea(const TPos3f &rPos) {
    ...
    rPos.getYDir(yDir);
    TVec3f front;
    front.set(rPos.mMtx[0][2], rPos.mMtx[1][2], rPos.mMtx[2][2]);
...
void TripodBoss::initBodyPosition() {
    ...
    _5D4 = v5;
    _5C8 = _5D4;
    MR::makeMtxTR((MtxPtr) & mBodyMtx, _5D4, mRotation);
}
...
bool TripodBoss::tryBreak() {
    if (MR::isValidSwitchB(this) && MR::isOnSwitchB(this)) {
        ...
        MR::requestStartDemoMarioPuppetable(this, "破壊", &NrvTripodBoss::TripodBossNrvPainDemo::sInstance, NULL);
        return true;
    }
...
void TripodBoss::requestOpeningDemo() {
    if (isNerve(&NrvTripodBoss::TripodBossNrvNonActive::sInstance)) {
        ...
        if (mSkipIntro)
        {
            setNerve(&NrvTripodBoss::TripodBossNrvSkipOpening::sInstance);
            return;
        }

        setNerve(&NrvTripodBoss::TripodBossNrvTryStartDemo::sInstance);
        MR::requestStartDemoMarioPuppetable(this, "開始", &NrvTripodBoss::TripodBossNrvStartDemo::sInstance, NULL);
    }
}
...
void TripodBoss::exeStartDemo() {
    if (MR::isFirstStep(this)) {
        ...
        if (!mNoMusicChange)
            MR::stopStageBGM(10);
        _600 = 1.0f;
        MR::startAnimCameraTargetSelf(this, mEventCamera, "StartDemo", 0, false, 1.0f);
        MR::startBck(this, "StartDemo", NULL);
    }
    ...
    if (MR::isStep(this, 120)) {
        if (!mNoMusicChange)
            MR::startStageBGM("MBGM_BOSS_02_A", false);
    }
...
void TripodBoss::exePainDemo() {
    if (MR::isFirstStep(this)) {
        ...
        startDemo();
        if (isOnGround) {
            MR::startBckPlayer("BattleWait", nullptr);
        }
        if (mDummyModel != NULL && MR::isExistBrk(mDummyModel, "Recover"))
            MR::startBrk(mDummyModel, "Recover");
        _620 = 5.0f;
        _600 = 0.0f;
    }
    ...
    if (MR::isStep(this, 90)) {
        ...
        mtx.mMtx[1][3] = v5.y;
        mtx.mMtx[2][3] = v5.z;
        MR::setPlayerBaseMtx((MtxPtr)&mtx);
        MR::startBckPlayer("Wait", (const char *)0);
        MR::startAnimCameraTargetSelf(this, mEventCamera, "EndDemo", 0, false, 1.0f);
        MR::startBck(this, "EndDemo", NULL);
...
void TripodBoss::exeExplosionDemo() {
    if (MR::isFirstStep(this)) {
        //MR::tryRumblePadVeryStrongLong(this, 0); // TODO:
    }
...
void TripodBoss::getJointAttachMatrix(TPos3f *pMtx, s32 a2) const {
    //PSMTXConcat((const MtxPtr)(), (const MtxPtr)(&), (MtxPtr)pMtx);
...
void TripodBoss::calcLegUpVector(TVec3f *pUp, const TVec3f &a2) {
    ...
    f32 v7 = axis->dot(v8);
    JMAVECScaleAdd((const Vec*)axis, (const Vec*)&v8, (Vec*)&v8, -v7);
    MR::normalizeOrZero(&v8);
    pUp->set(v8);
}
...
void TripodBoss::calcDemoMovement() {
    ...
    MR::blendMtx((MtxPtr)&_EC, (MtxPtr)&mtx, _600, (MtxPtr)&mBodyMtx);
...
void TripodBoss::addAccelToWeightPosition() {
    ...
    TVec3f v18, v19, v20;
    TBoxVec3f v22;
    v22.mPointMin.set(_5C8);
    v22.mPointMax.set(_5C8);
    v21.mPointMin.set(_5C8);
    v21.mPointMax.set(_5C8);
    ...
    JMAVECLerp((const Vec*)&v22.mPointMax, (const Vec*)&v22.mPointMin, (Vec*)&v20, 0.5f);
    
    JMAVECLerp((const Vec*)&v21.mPointMax, (const Vec*)&v21.mPointMin, (Vec*)&v19, 0.5f);
    
    MR::vecBlend(&v18, v19, v20, 0.3f);
    TVec3f* center = &mMovableArea->mCenter;
    TVec3f v14(v18);
    v14 -= *center;
    TVec3f* axis = &mMovableArea->mBaseAxis;
    f32 v7 = axis->dot(v14);
    JMAVECScaleAdd((const Vec*)axis, (const Vec*)&v14, (Vec*)&v18, -v7);
    ...
    TVec3f v15(v16);
    v15 -= _5D4;
    f32 v10 = PSVECMag((const Vec*) & v15);
    if (v10 < 500.0f) {
        v10 = 500.0f;
    }
...
void TripodBoss::calcClippingSphere() {
    TBoxVec3f v4;
    v4.mPointMin.set(_5D4);
    v4.mPointMax.set(_5D4);

    for (u32 i = 0; i < 3; i++) {
        v4.extend(mLegs[i]->mForceEndPoint);
    }

    JMAVECLerp((const Vec*)&v4.mPointMax, (const Vec*)&v4.mPointMin, (Vec*)&_5EC, 0.5f);
}
...
// NEW to SMG2
void TripodBoss::exeSkipOpening() {
    if (MR::isFirstStep(this)) {
        startDemo();
        _600 = 1.0f;
        calcDemoMovement();
...
void TripodBoss::checkRideMario() {
    GravityInfo info;
    TVec3f v8;
    __kAutoMap_8002B2D0(this, *MR::getPlayerPos(), 5, &v8, &info, 0); //MR::calcGravityAndMagnetVector(this, *MR::getPlayerPos(), v8, &info, 0);

    if (info.mGravityInstance != NULL && MR::isTripoddBossParts((const NameObj*)info.mGravityInstance->mHost)) {
        _630 = 120;
    }    
    else {
        if (_630 > 0) {
...
void TripodBoss::changeBgmState() {
    if (_640 && !isDemo()) {
        if (!MR::isPlayingStageBgm()) {
            if (!mNoMusicChange)
                MR::startStageBGM("MBGM_BOSS_02_B", false);
        }
